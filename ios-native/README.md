<!--
  ...
  Changes: Wake/sparkle parity with Android — Bloom subdiv-1 soap rings,
  Luna/Spore plankton no 600 cap, live hulls not rasterized.
  Encounter catalog + Open Space weather/belt generated by npm run constants:export.
  Ship IAP + Restore Purchases via RevenueCat; UNLOCK_ALL_SKINS true for playtest.
-->
