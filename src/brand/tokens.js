...
// --- Color -------------------------------------------------------------------
// A deliberately tiny, monochrome-plus-one palette. Warm paper ground, ink for
// everything structural, and a single electric "signal" blue as the only accent.
export const color = {
...
export const motif = {
    ...
    // `fill: 'ink'` = solid #1A1A1A, `signal` = the blue accent, `ink30` = trail.
    elements: {
